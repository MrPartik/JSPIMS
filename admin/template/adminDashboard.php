...
<body>
	...
	<div id="page-container" class="fade page-sidebar-fixed page-header-fixed page-with-wide-sidebar">
		...
		<div id="content" class="content">
			...
			<!-- end breadcrumb -->
			<!-- begin page-header -->
			<h1 class="page-header">Dashboard v2 <small></small></h1>
			<!-- end page-header -->
			<!-- begin row -->
			<div class="row">
			    <!-- begin col-3 -->
			    <div class="col-lg-3 col-md-6">
			        <div class="widget widget-stats bg-orange-transparent-7">
			        	...
			        	<div class="stats-content">
							...
							<div class="stats-title">CURRENT ACADEMIC YEAR</div>
			    ...
			    <div class="col-lg-3 col-md-6">
			        <div class="widget widget-stats bg-red-transparent-7">
						...
						<div class="stats-content">
							...
							<div class="stats-title">TOTAL NO. OF APPLICANTS</div>
							<div class="stats-number"><?php echo $totalapp ?></div>
						</div>
			        </div>
			    </div>
			    <!-- end col-3 -->
			    ...
			    <div class="col-lg-3 col-md-6">
			        <div class="widget widget-stats bg-aqua-darker">
			        	...
			        	<div class="stats-content">
							...
							<div class="stats-title">TOTAL NO. OF PROGRAMS</div>
							<div class="stats-number"><?php echo $totalprog; ?></div>
						</div>
			        </div>
			    </div>
			    <!-- end col-3 -->
			    ...
			    <div class="col-lg-3 col-md-6">
			        <div class="widget widget-stats bg-deep-purple">
			        	...
			        	<div class="stats-content">
							...
							<div class="stats-title">EXAMS TAKEN</div>
							<div class="stats-number"><?php echo $examtaken; ?></div>
			        </div>
			    </div>
			    <!-- end col-3 -->
			</div>
