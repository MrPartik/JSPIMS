		...
		<div id="content" class="content">
			...
			<div class="panel panel-inverse">
				<div class="panel-heading">
					<h4 class="panel-title">Program Table</h4>
				</div>
				<div class="panel-body">
					<div style="padding: 20px;"><a href="#modal-dialog" class="btn btn-sm btn-success" data-toggle="modal"><i class="fas fa-plus"></i> Add Program</a></div>
                            <table id="data-table-buttons" class="table table-striped table-bordered">   
                                ...
                                <tbody><?php 
	                                $tablesql = "SELECT * from program WHERE PROG_STAT = 0 ORDER BY PROG_ID DESC";
            ...
            else
            {
                ...
                function(isConfirm){
                    if (isConfirm) {
                        ...
                        $.ajax({
                                    type: 'POST',
                                    url: 'INCLUDES/submitProgram.php',
                                    async: false,
                                    data: {
                                        _program: program
                                    ...
                                    success: function(data) {
                                        ...
                                        swal("Program added! ", "Page will be reloaded.", "success");
                                        
                                        setTimeout(function() 
                                        {
                                            window.location = 'adminProgram.php';
