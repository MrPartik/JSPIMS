		...
		<div id="content" class="content">
			...
			<div class="panel panel-inverse">
				<div class="panel-heading">
					<h4 class="panel-title">Non-Requisition</h4>
				</div>
				<div class="panel-body">
						<table id="data-table-buttons" class="table table-striped table-bordered">  
                                ...
                                <?php 
                                    ...
                                    $acq= mysqli_query($connect, "SELECT * FROM t_spare_acquisition as a 
                                                                    inner join t_spare_stocks as b
                                                                    on a.ITEM_NAME = b.STOCK_ID
                                                                    ");
                                    while ($row=mysqli_fetch_assoc($acq)) {
                                        $aqid = $row["AQ_ID"];
                                        $aqdate = $row["AQ_DATE"];
                                        $aqitem = $row["STOCK_NAME"];
                                        $aqbrand = $row["ITEM_BRAND"];
                                        $aqcondi = $row["ITEM_CONDITION"];
                                        $aqunit = $row["ITEM_UNIT"];
                                        $aqqty= $row["ITEM_QUANTITY"];
                                        $aqsup = $row["SUPPLIER"];
                                
                                ?>
                                    <tr class="odd gradeX">
                                    	<td><?php echo $aqid;?></td>
                                        <td><?php echo $aqdate;?></td>
                                        <td><?php echo $aqitem;?></td>
                                        <td><?php echo $aqbrand.' '. $aqcondi.' '. $aqunit;?></td>
                                        <td><?php echo $aqqty;?></td>
                                        <td><?php echo $aqsup;?></td>
                                        <td><span class="label label-info m-l-5">Manual Acquisition</span></td>
