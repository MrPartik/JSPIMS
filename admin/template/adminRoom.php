		...
		<div id="content" class="content">
			...
			<div class="panel panel-inverse">
				<div class="panel-heading">
					<h4 class="panel-title">Room Table</h4>
				</div>
				<div class="panel-body">
					<div style="padding: 20px;"><a href="#modal-dialog" class="btn btn-sm btn-success" data-toggle="modal"><i class="fas fa-plus"></i> Add Room</a></div>
										...
										<div class="modal-body">
											<form>
												<div class="form-group row m-b-10">
													<label class="col-md-3 col-form-label text-md-right">Building <span class="text-danger">*</span></label>
													<div class="col-md-6">
														 <select class="form-control" name="fchoice" id="bldg" data-parsley-group="step-3" data-parsley-required="true">
														 	<option value="" selected disabled>Select building</option>
				                                            <?php 
					                                            $selectcat = "SELECT * FROM building where bldg_stat = 1 ";

					                                            $selectresult = mysqli_query($connect, $selectcat) or die("Bad Query: $sql");
					                                            while($row = mysqli_fetch_assoc($selectresult)){
					                                                 $prod_cat_name = $row['BLDG_NAME'];
					                                                 $prod_cat_id = $row['BLDG_ID'];   
												...
												<div class="form-group row m-b-15">
													<label class="col-md-3 col-form-label text-md-right">Room Name</label>
													<div class="col-md-9">
														<input type="text" class="form-control m-b-5" id="room" name="room" placeholder="ex. 2019-2020" />
