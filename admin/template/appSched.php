				...
				<ul class="nav">
					...
					<li class="has-sub active">
						...
						<ul class="sub-menu">
							...
							<li><a href="appRoom.php">List of Applicants by Room</a></li>
							<li class="active"><a href="appSched.php">List of Applicants by Sched</a></li>
						</ul>
					</li>
				...
				<div class="panel-body">
					<form>
						<div class="form-group row m-b-10">
							<label class="col-md-3 col-form-label text-md-right">Filtery by Room: <span class="text-danger"></span></label>
							<div class="col-md-6">
								 <select class="form-control" name="fchoice" id="prog" data-parsley-group="step-3" data-parsley-required="true">
								 	<option value="" selected disabled>Select schedule</option>
	                                <?php 
	                                    $selectcat = "SELECT * FROM SCHED AS A INNER JOIN ACADYR AS B ON A.ACADYR_FK = B. ACADYR where A.SCHED_STAT = 0 ";

	                                    $selectresult = mysqli_query($connect, $selectcat) or die("Bad Query: $sql");
	                                    while($row = mysqli_fetch_assoc($selectresult)){
	                                         $prod_cat_name = $row['SCHED_TIME']. '-'. $row['SCHED_DATE'].'/ A.Y. '.$row['ACADYR_NAME'];
	                                         $prod_cat_id = $row['SCHED_ID'];   
	...
	<script type="text/javascript">
 	 ...
 	 function fetch_item_data()
		 {var e2 = document.getElementById('prog');
		  var prog = e2.options[e2.selectedIndex].value;
		  $.ajax({
		   url:"fetchBySched.php",
		   method:"POST",
		   data:{prog:prog},
