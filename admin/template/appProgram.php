			...
			<div data-scrollbar="true" data-height="100%">
				...
				<ul class="nav">
					...
					<li class="has-sub active">
						...
						<ul class="sub-menu">
							<li class="active"><a href="appProgram.php">List of Applicants by Program</a></li>
				...
				<div class="panel-body">
					<form>
						<div class="form-group row m-b-10">
							<label class="col-md-3 col-form-label text-md-right">Filtery by program: <span class="text-danger"></span></label>
							<div class="col-md-6">
