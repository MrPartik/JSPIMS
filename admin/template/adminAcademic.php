...
<body>
	...
	<div id="page-container" class="page-container fade page-sidebar-fixed page-header-fixed page-with-wide-sidebar">
			...
			<ul class="navbar-nav navbar-right">
					...
					<ul class="dropdown-menu media-list dropdown-menu-right">
						...
						<li class="media">
							<a href="javascript:;">
								...
								<div class="media-body">
									<h6 class="media-heading"><?php echo $username; ?></h6>
				...
				<li class="dropdown navbar-user">
					<a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown">
						<span class="d-none d-md-inline">Hi, <?php echo $username; ?></span>
		...
		<div id="content" class="content">
			...
			<!-- end breadcrumb -->
			<!-- begin page-header -->
			<h1 class="page-header">Manage Academic Year</h1>
			<!-- end page-header -->
			
			<!-- begin panel -->
			<div class="panel panel-inverse">
				<div class="panel-heading">
					<h4 class="panel-title">Academic Year Table</h4>
				</div>
				<div class="panel-body">
					<div style="padding: 20px;"><a href="#modal-dialog" class="btn btn-sm btn-success" data-toggle="modal"><i class="fas fa-plus"></i> Add Academic Year</a></div>
                            <table id="data-table-buttons" class="table table-striped table-bordered">   
                            	
                                <thead>
                                    <tr>
                                        <th class="text-nowrap">#</th>
                                        <th class="text-nowrap">School Year Period</th>
                                    </tr>
                                </thead>
                                
                                <tbody><?php 
	                                $tablesql = "SELECT * from ACADYR WHERE ACADYR_STAT = 0 ORDER BY ACADYR DESC";
										...
										<div class="modal-body">
											<form>
												<div class="form-group row m-b-15">
													...
													<div class="col-md-9">
														<input type="text" class="form-control m-b-5" id="syear" name="syear" placeholder="ex. 2019-2020" />
        ...
        $('#submit').click(function(e){
           ...
           // var u_pass = document.getElementById('defpass').value;
            ...
            if (syear == "")
            {
                ...
                alert("You did not made any entry!");
                    ...
                    if (isConfirm) {
                        ...
                        $.ajax({
                                    ...
                                    success: function(data) {
                                        ...
                                        swal("School year added! ", "Page will be reloaded.", "success");
                                        
                                        setTimeout(function PrintElem(elem) 
                                        {
                                            window.location = 'adminAcademic.php';
