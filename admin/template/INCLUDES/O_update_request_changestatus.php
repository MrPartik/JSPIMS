<?php
      $connect = mysqli_connect('localhost','root','','jspims');
	   ...
	   $bno = $_POST['bno'];
	    ...
	    $add_purchase = mysqli_query($connect,"INSERT INTO `t_spare_requisition_purchased` (`REF_BATCH_NO`, `DATE_PURCHASED`, `PURCHASE_STATUS`, `DELIVERY_DATE`, `PURCHASE_ACCEPT_STATUS`) VALUES ('$bno', CURRENT_DATE, '2', NULL, '1')");
?>