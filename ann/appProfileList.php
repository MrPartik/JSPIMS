        ...
        <tr>
          <td height="850" class="content-home" valign="top">
			...
			?>
              ...
              <tr>
                <td align="center"><iframe width="750" height="700" src="appProfileList_frame.php?search=<?php echo $_POST['search'] ?>" marginheight="1" marginwidth="1"  frameborder="1" scrolling="Yes" > </iframe></td>
                </tr>
              <tr>
                <td height="19">&nbsp;</td>
                </tr>
