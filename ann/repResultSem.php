...
<tr><td height="850" class="services-page">
  ...
  <td width="838" valign="top"><table width="800" border="0" align="center" cellpadding="0" cellspacing="0">
    ...
    <tr>
      ...
      <td ><table width="795" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td class="content-home"><h3>EXAM RESULT BY PERIOD</h3>
            </td>
        </tr>
        <tr>
          <td height="850" class="content-home" valign="top">
			...
			?>
              ...
              <tr>
                <td width="456" valign="top"><table width="500" border="0" align="center" cellpadding="0" cellspacing="0">
                  <tr>
  ...
  ?>
			  ...
			  ?>
                <td align="center"><iframe width="730" height="700" src="repResultSem_frame.php?search=<?php echo $_POST['selPeriod'] ?>&&progCh=<?php echo $progCh ?>&&prog=<?php echo $_POST['program'] ?>&&sex=<?php echo $_POST['sex'] ?>" marginheight="1" marginwidth="1"  frameborder="1" scrolling="Yes" > </iframe></td>
                </tr>
              <tr>
                <td height="19">&nbsp;</td>
                </tr>
...
$pageName="EXAM RESULT BY PERIOD";
