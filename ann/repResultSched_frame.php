...
if ($search<>''){
  ...
  <tr>
	...
	<a href="repResultSchedList.php?search=<?php echo $search ?>&&sched=<?php echo $row->scID ?>&&progCh=<?php echo $progCh ?>&&prog=<?php echo $program ?>&&sex=<?php echo $sex ?>" target="_parent"><?php echo $row->scID ?></a></div></td>
...
$page2 = "repResultSched_frame.php";
$pageBack="repResultSched.php";
$user=$_SESSION['user'];
$ar=$_SESSION['rights'];
$subMenu="repMenu";
