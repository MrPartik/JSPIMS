  ...
  <td width="838" valign="top"><table width="800" border="0" align="center" cellpadding="0" cellspacing="0">
    ...
    <tr>
      ...
      <td ><table width="795" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td class="content-home"><h3>create EXAM </h3>
            </td>
        </tr>
        <tr>
          <td height="850" class="content-home" valign="top">
			...
			?>&nbsp;</td>
              ...
              <tr>
                <td width="26">&nbsp;</td>
                <td width="754"><a href="exmCreateAdd.php">Create Exam - Add Item</a></td>
              </tr>
              <tr>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
              ...
              <tr>
                <td colspan="2" align="center"><iframe width="730" height="700" src="exmCreate_frame.php?search=<?php echo $_POST['selPeriod'] ?>&&topic=<?php echo $_POST['topic'] ?>" marginheight="1" marginwidth="1"  frameborder="1" scrolling="Yes" > </iframe>&nbsp;</td>
                </tr>
              <tr>
