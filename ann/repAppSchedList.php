...
$search=$_GET['search'];
	...
	mysql_query("SET CHARACTER_SET 'utf8'", $conn);
	 $query="select * FROM sched where scID='$search'";
        ...
        <tr>
          <td height="850" class="content-home" valign="top">
			...
			?>
              ...
              <tr>
                <td align="center"><iframe width="730" height="700" src="repAppSchedList_frame.php?search=<?php echo $_GET['search'] ?>" marginheight="1" marginwidth="1"  frameborder="1" scrolling="Yes" > </iframe></td>
                </tr>
              <tr>
                <td height="19">&nbsp;</td>
                </tr>
