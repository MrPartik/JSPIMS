  ...
  <td width="838" valign="top"><table width="800" border="0" align="center" cellpadding="0" cellspacing="0">
    ...
    <tr>
      ...
      <td ><table width="795" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td class="content-home"><h3>APPLICANT BY exam schedule</h3>
            </td>
        </tr>
        <tr>
			...
			?>
              ...
              <tr>
                <td width="456" valign="top"><table width="730" border="0" align="center" cellpadding="0" cellspacing="0">
                  <tr>
                    <td width="143" >Select Period </td>
                    <td width="383" class="text"><select name="selPeriod" class="textfield">
                      <?php
				  selPeriod();
          		?>
                      </select></td>
              ...
              <tr>
                <td align="center"><iframe width="730" height="700" src="repAppSched_frame.php?search=<?php echo $_POST['selPeriod'] ?>" marginheight="1" marginwidth="1"  frameborder="1" scrolling="Yes" > </iframe></td>
              </tr>
              <tr>
                <td height="19">&nbsp;</td>
                </tr>
...
$pageName="APPLICANT BY EXAM SCHEDULE";
